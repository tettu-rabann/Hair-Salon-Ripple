...
<html lang="ja" dir="ltr">
  ...
  <body>
    ...
    <div class="salon_detaile-wrapper">
      <div class="container">
        <h1>Salon</h1>
        ...
        <div class="salon-plan">
          ...
          <div class="salon-row">
            <h2>Shampoo <span>シャンプー</span> </h2>
            <p>￥ 800</p>
          </div>
          <div class="salon-row">
            <h2>Blow <span>ブロー</span> </h2>
            <p>￥ 1,000</p>
          </div>
          <div class="salon-row">
            <h2>Set <span>セット</span> </h2>
            <p>￥ 1,200</p>
          </div>
          <div class="salon-row">
            <h2>Treatment <span>トリートメント</span> </h2>
            <p>￥ 800</p>
          </div>
        </div>
        </p>
